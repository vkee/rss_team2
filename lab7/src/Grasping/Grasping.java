...
//                    TODO: may need to do stuff with camera to make sure that the object is grasped
...
//                    TODO: will need to have recovery methods
                    if (!objDetected) {
//                        Attempting recovery by restarting but probably need a recovery state and then align with block
