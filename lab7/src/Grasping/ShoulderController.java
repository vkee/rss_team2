...
public class ShoulderController extends JointController {
	...
	private int GYM_UP_PWM = 1700;// hardcoded for now
...
//		GYM_UP_PWM = maxPWM;
	...
	/**
	 * Determines whether the shoulder joint is at the move up with a desired
	 * angle state
	 * 
	 * @param currPWM
	 *            the last PWM value written to the shoulder
	 */
	...
	/**
	 * Determines whether the shoulder joint is such that the arm is on the
	 * ground
	 * 
	 * @param currPWM
	 *            the last PWM value written to the shoulder
	...
	/**
	 * Returns the PWM value to write to the shoulder servo to move the arm to
	 * the ground
	 * 
	 * @param currPWM
	 *            the last PWM value written to the shoulder
