...
(cl:defmethod gripper-val ((m <BumpMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rss_msgs-msg:gripper-val is deprecated.  Use rss_msgs-msg:gripper instead.")
  (gripper m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<BumpMsg>)))
  ...
  "4ad52800b0ed4e859da7531bd4962980")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'BumpMsg)))
  "Returns md5sum for a message object of type 'BumpMsg"
  "4ad52800b0ed4e859da7531bd4962980")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<BumpMsg>)))
  ...
  (cl:format cl:nil "bool left~%bool right~%bool gripper~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'BumpMsg)))
  "Returns full string definition for message of type 'BumpMsg"
  (cl:format cl:nil "bool left~%bool right~%bool gripper~%~%~%"))
