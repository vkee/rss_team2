...
/**
 * <p>
 * The 2D {@link #worldRect}, {@link PolygonObstacle} {@link #obstacles},
 * {@link #robotStart}, and {@link #robotGoal} that make-up the environment in
 * which the robot will navigate.
 * </p>
 *
 * <p>
 * You can either make an instance of this class and use it from within your own
 * program (typical usage), or you can run this code as an indepedent process
 * (see {@link #main}). The latter mode allows you to display the contents of a
 * map file, but does not give programmatic access to those contents, and thus
 * is useful mostly for displaying/debugging map files.
 * </p>
 * .
 *
 * <p>
 * The format of the map file is as follows (all items are signed doubles in
 ...
 * </pre>
 * 
 * The first three lines initialize the corresponding instance fields
 * {@link #robotStart}, {@link #robotGoal}, and {@link #worldRect},
 * respectively. Each obstacle line gives the coordinates of the obstacle's
 * vertices in CCW order. There may be zero obstacles.
 * </p>
 *
 * @author Marty Vona
...
public class PolygonMap implements NodeMain {
	 ...
	 * </p>
	 **/
	protected LinkedList<PolygonObstacle> obstacles = new LinkedList<PolygonObstacle>();

	protected List<PolygonObstacle> cspace_obstacles;
	...
	/**
	 * <p>
	 * Create a new map, parsing <code>mapFile</code>.
	 * </p>
	 *
	 * @param mapFile
	...
	protected void addCSpace(List<PolygonObstacle> poly) {
		cspace_obstacles = poly;
	}

	/**
	 * <p>
	 * Parse a <code>double</code>.
	 * </p>
	 *
	 * @param br
	 *            the double is expected to be on the next line of this reader
	 * @param name
	...
	/**
	 * <p>
	 * Parse a <code>Point2D.Double</code>.
	 * </p>
	 *
	 * @param point
	 *            the returned point
	 * @param br
	 *            the point is expected to be on the next line of this reader
	 * @param name
	 ...
	 *                if there was a format error
	 **/
	protected void parsePoint(Point2D.Double point, BufferedReader br,
			String name, int lineNumber) throws IOException, ParseException,
	...
	/**
	 * <p>
	 * Parse a <code>Rectangle2D.Double</code>.
	 * </p>
	 *
	 * @param rect
	 *            the returned rectangle
	 * @param br
	 *            the rect is expected to be on the next line of this reader
	 * @param name
	 *            the name of the rect
	 * @param lineNumber
	 ...
	 *                if there was a format error
	 **/
	protected void parseRect(Rectangle2D.Double rect, BufferedReader br,
			String name, int lineNumber) throws IOException, ParseException,
			NumberFormatException {
	...
	/**
	 * <p>
	 * Parse a {@link PolygonObstacle}.
	 * </p>
	 *
	 * @param br
	 *            the polygon is expected to be on the next line of this reader
	 * @param name
	 ...
	 *                if there was a format error
	 **/
	protected PolygonObstacle parseObs(BufferedReader br, String name,
			int lineNumber) throws IOException, ParseException,
			NumberFormatException {
	...
	/**
	 * <p>
	 * Hook called from {@link #parse} after the first four lines are parsed to
	 * allow subclasses to parse extra lines before the obstacles.
	 * </p>
	 *
	 * <p>
	 ...
	 *
	 * @param br
	 *            the next line of this reader is the next to be parsed
	 * @param lineNumber
	...
	/**
	 * <p>
	 * Parse <code>mapFile</code>.
	 * </p>
	 *
	 * <p>
	 * Format is specified in the class header doc for {@link PolygonMap}.
	 * </p>
	 *
	 * @param mapFile
	...
	protected void parse(File mapFile) throws IOException, ParseException {
		...
		try {
			...
			for (int obstacleNumber = 0;; obstacleNumber++) {
				...
				PolygonObstacle poly = parseObs(br, "obstacle "
						+ obstacleNumber, lineNumber++);
				if (poly != null) {
	...
	/**
	 * <p>
	 * Parses the specified map file, prints it out, and displays it in the GUI,
	 * if any.
	 * </p>
	 *
	 * <p>
	 * Usage: {@link #getAppName} &lt;mapfile&gt; [centralhost]
	 * </p>
	 **/
	...
	/**
	 * <p>
	 * Hook called after painting map objects in {@link #instanceMain} to allow
	 * subclasses to display extra stuff.
	 * </p>
	 *
	 * <p>
