...
public class MotionPlanner {
	...
	private final int NUM_TRIES = 10000;
	...
	public List<Point2D.Double> getPath(Point2D.Double start,
		...
		while (tries < NUM_TRIES) {
			...
			for (PolygonObstacle p : map.cspace_obstacles) {
				// If the path to the new node intersects a polygon, we cannot
				// add the node
	...
	/**
	 * Returns whether the line segment representing the path intersects the
	 * obstacle
	 * 
	 * @param p
	 * @param x1
