...
public class GlobalNavigation implements NodeMain {
    ...
    //    Shift in Robot Position adjusting for robotX,Y, and theta not always zeroed at start
    //    Essentially the shift to get it to the start position, assuming that the robot is at the starting position
